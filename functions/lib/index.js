...
async function generateQuestions(prompt) {
    ...
    try {
        ...
        const content = ((_a = response.choices[0].message.content) === null || _a === void 0 ? void 0 : _a.trim()) || "";
...
async function generateCaption() {
    var _a;
    const prompt = ("Rewrite this social media caption in a fresh, casual way that still means the same thing: " +
    ...
    try {
        ...
        return ("Questions to explore with your person 💬 Save these to talk through together later. " +
...
exports.generateQuestionGroup = (0, https_1.onRequest)(async (request, response) => {
    try {
        ...
        response.json({
            ...
            questionGroup: Object.assign({ id: docRef.id }, questionGroup),
            timestamp: new Date().toISOString()
        });
    }
    catch (error) {
