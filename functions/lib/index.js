...
exports.processVideo = exports.generateContent = exports.listVideos = exports.testConfig = exports.healthCheck = void 0;
...
exports.generateContent = functions.https.onRequest(async (request, response) => {
    try {
